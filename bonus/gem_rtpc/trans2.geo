...
//--GEM2
p2 = newp; Point(p2) = {7.31,0,-20,0.5};
p3 = newp; Point(p3) = {0,7.31,-20,0.5};
p4 = newp; Point(p4) = {-7.31,0,-20,0.5};
p5 = newp; Point(p5) = {0,-7.31,-20,0.5};
...
//--
//--GEM2
p6 = newp; Point(p6) = {7.6,0,-20,0.5};
p7 = newp; Point(p7) = {0,7.6,-20,0.5};
p8 = newp; Point(p8) = {-7.6,0,-20,0.5};
p9 = newp; Point(p9) = {0,-7.6,-20,0.5};
...
//--The two surfaces for the GEM2 and GEM3 foils
pphys1 = newreg; Physical Surface("GEM2",pphys1) = {32, 24, 28, 36};
pphys2 = newreg; Physical Surface("GEM3",pphys2) = {48, 44, 52, 40};

//--The drift volume
pphys3 = newreg; Physical Volume("GEM2-GEM3 Drift Area",pphys3) = {vol_index[1]};
